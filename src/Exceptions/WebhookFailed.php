...
namespace Vanthao03596\PaddleWebhooks\Exceptions;
...
class WebhookFailed extends Exception
{
    ...
    {
        return new static("Webhook call id `{$webhookCall->id}` did not contain a type. Valid Paddle webhook calls should always contain a type.");
    }
